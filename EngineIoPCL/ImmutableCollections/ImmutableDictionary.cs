...
namespace Quobject.Collections.Immutable
{
    ...
    public class ImmutableDictionary<TKey, TValue> : IImmutableDictionary<TKey, TValue> where TKey : IComparable<TKey>
    {
        internal static readonly ImmutableDictionary<TKey, TValue> Empty = new ImmutableDictionary<TKey, TValue>();
        private readonly IEqualityComparer<TKey> keyComparer;
        private readonly AvlNode<KeyValuePair<TKey, TValue>> root = AvlNode<KeyValuePair<TKey, TValue>>.Empty;
        ...
        internal ImmutableDictionary(AvlNode<KeyValuePair<TKey, TValue>> root, IEqualityComparer<TKey> keyComparer,
        ...
        public sealed class Builder : IDictionary<TKey, TValue>
        {
            ...
            internal Builder(AvlNode<KeyValuePair<TKey, TValue>> root, IEqualityComparer<TKey> keyComparer,
                IEqualityComparer<TValue> valueComparer)
            {
        ...
        public ImmutableDictionary<TKey, TValue> Remove(TKey key)
        {
            ...
            return new ImmutableDictionary<TKey, TValue>(root.RemoveFromNew(pair, CompareKV, out found), keyComparer,
                valueComparer);
        }
    ...
    {
        public static bool Contains<TKey, TValue>(this IImmutableDictionary<TKey, TValue> dictionary, TKey key,
            TValue value)
        {
            if (dictionary == null)
        ...
        public static ImmutableDictionary<TKey, TValue> Create<TKey, TValue>(IEqualityComparer<TKey> keyComparer,
            IEqualityComparer<TValue> valueComparer, IEnumerable<KeyValuePair<TKey, TValue>> items)
            where TKey : IComparable<TKey>
        {
            return Create(keyComparer, valueComparer).AddRange(items);
        }

        public static ImmutableDictionary<TKey, TValue> Create<TKey, TValue>(IEqualityComparer<TKey> keyComparer,
            IEnumerable<KeyValuePair<TKey, TValue>> items) where TKey : IComparable<TKey>
        {
        ...
        public static ImmutableDictionary<TKey, TValue> Create<TKey, TValue>(IEqualityComparer<TKey> keyComparer,
            IEqualityComparer<TValue> valueComparer) where TKey : IComparable<TKey>
        {
        ...
        public static TValue GetValueOrDefault<TKey, TValue>(this IReadOnlyDictionary<TKey, TValue> dictionary, TKey key,
            TValue defaultValue) where TKey : IComparable<TKey>
        {
            if (dictionary == null)
                throw new ArgumentNullException("dictionary");
            TValue result;
        ...
        public static ImmutableDictionary<TKey, TValue> ToImmutableDictionary<TKey, TValue>(
            this IEnumerable<KeyValuePair<TKey, TValue>> source, IEqualityComparer<TKey> keyComparer)
            where TKey : IComparable<TKey>
        {
        ...
        public static ImmutableDictionary<TKey, TValue> ToImmutableDictionary<TKey, TValue>(
            this IEnumerable<KeyValuePair<TKey, TValue>> source) where TKey : IComparable<TKey>
        {
            ...
            IEqualityComparer<TValue> valueComparer) where TKey : IComparable<TKey>
        {
            if (source == null)
                throw new ArgumentNullException("dictionary");
            return Create(keyComparer, valueComparer).AddRange(source);
        }
        ...
        public static ImmutableDictionary<TKey, TValue> ToImmutableDictionary<TSource, TKey, TValue>(
            ...
            IEqualityComparer<TKey> keyComparer) where TKey : IComparable<TKey>
        {
        ...
        public static ImmutableDictionary<TKey, TValue> ToImmutableDictionary<TSource, TKey, TValue>(
            this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TValue> elementSelector,
            IEqualityComparer<TKey> keyComparer, IEqualityComparer<TValue> valueComparer) where TKey : IComparable<TKey>
        {
            if (source == null)
                throw new ArgumentNullException("dictionary");
            return
                Create(keyComparer, valueComparer)
                    .AddRange(source.Select(x => new KeyValuePair<TKey, TValue>(keySelector(x), elementSelector(x))));
        }
